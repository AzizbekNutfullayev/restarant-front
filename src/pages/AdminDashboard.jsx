...
const AdminDashboard = () => {
  ...
  const fetchHalls = () => {
    axios.get("https://restarant-bacent.onrender.com/admin/toyxonalar")
  ...
  const handleApprove = (id) => {
    axios.patch(`https://restarant-bacent.onrender.com/admin/toyxonalar/${id}/approve`)
      .then(() => fetchHalls())
      .catch(err => {
  ...
  const handleDelete = (id) => {
    if (window.confirm("Bu toyxonani ochirishga ishonchingiz komilmi?")) {
      axios.delete(`https://restarant-bacent.onrender.com/admin/toyxonalar/${id}`)
        .then(() => fetchHalls())
        .catch(err => {
