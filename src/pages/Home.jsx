...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const loadHalls = async () => {
      try {
        setLoading(true);
        const res = await axios.get("https://restarant-bacent.onrender.com/user/img");
        console.log("✅ Backend javobi (halls):", res.data);
  
        const hallsWithFullImageUrl = res.data.map(hall => ({
          ...hall,
          image: hall.image ? `https://restarant-bacent.onrender.com/${hall.image}` : null
        }));
  ...
  useEffect(() => {
    ...
    const getBookedDates = async () => {
      try {
        const res = await axios.get(`https://restarant-bacent.onrender.com/api/bron/hall/${selectedHall.id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://restarant-bacent.onrender.com/api/bron/create", payload);
