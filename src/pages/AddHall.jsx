...
const AddHall = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://restarant-bacent.onrender.com/toyxonalar/", payload);
      ...
      await axios.post("https://restarant-bacent.onrender.com/toyxonalar/upload-image", formData, {
        headers: {
